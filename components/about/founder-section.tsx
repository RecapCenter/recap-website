...
export function FounderSection() {
  return (
    <section
      ...
      style={{ background: "linear-gradient(160deg, #e4eef5 0%, #d3e4ee 100%)" }}
    >
      <div className="mx-auto max-w-[1200px]">
        <FadeIn className="text-center md:text-left">
          <span className="font-script text-xl text-ink/70">meet the founder</span>
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 md:grid-cols-[minmax(0,340px)_1fr] md:gap-16">
          <FadeIn delay={0.1} className="relative mx-auto w-full max-w-[280px] md:mx-0">
            ...
            <span className="absolute -bottom-3 right-2 rotate-3 rounded bg-[#fdf1a8] px-3 py-1 font-script text-lg text-ink shadow-sm">
              that&rsquo;s her!
            </span>
          </FadeIn>
          ...
          <FadeIn delay={0.2} className="flex flex-col gap-5">
            <div>
              <h3 className="font-display text-3xl font-bold text-ink">Dr. Reya Rao</h3>
              <p className="mt-1 text-sm text-body-gray">Founder, Clinical Psychologist</p>
            </div>

            <div className="flex flex-col gap-4 text-base leading-relaxed text-body-gray">
              <p>
                Reya has spent the last decade sitting with children who felt too
                much, families who felt too little, and teachers who felt
            ...
            <div>
              <span className="text-xs font-semibold uppercase tracking-widest text-body-gray">
                Credentials
              </span>
