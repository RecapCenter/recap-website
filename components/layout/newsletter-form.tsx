  ...
  return (
    ...
    >
      <div className="flex h-11 items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4">
        <Mail className="size-4 shrink-0 text-footer-muted" />
        <input
          type="email"
          required
          value={email}
          ...
          className="w-full bg-transparent text-sm text-cream placeholder:text-footer-muted focus:outline-none sm:w-56"
        />
      </div>
