...
function SproutIcon() {
  return (
    <svg
      viewBox="0 0 32 32"
      className="mx-auto size-8 text-[#9cae8e]"
      fill="none"
      aria-hidden
    >
      <path
  ...
  return (
    <section className="bg-contact-bg relative overflow-hidden px-6 py-24 text-center md:py-32">
      ...
      <FadeIn className="relative mx-auto max-w-3xl">
        ...
        <h1 className="text-contact-ink mt-6 font-serif text-3xl leading-tight md:text-5xl">
          from a <em className="text-contact-accent">quiet thought</em>
          <br />
          to a real conversation
        </h1>
        <p className="text-contact-body mx-auto mt-6 max-w-xl text-base leading-relaxed">
