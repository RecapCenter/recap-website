...
[WORDPRESS_CMS.md](WORDPRESS_CMS.md) for the planned headless WordPress
integration (Home/About/Services/Header/Footer are static; blog, gallery,
freebies, recommendations, and lab content are planned to come from
